...
# (funcionario)
from entrada_de_dados.lista_de_funcionarios_registrados import funcionario_batista_melo2384728974
...
# (veiculo)
from entrada_de_dados.lista_de_carros_registrados import carro_wolkswagen_gol_339991
...
add_venda_na_lista_do_main(venda_115167)
...
# (veiculo)
from entrada_de_dados.lista_de_carros_registrados import carro_toyota_hilux_377261
...
add_venda_na_lista_do_main(venda_27637)
...
# (veiculo)
from entrada_de_dados.lista_de_carros_registrados import carro_toyota_corolla_754655
...
add_venda_na_lista_do_main(venda_367251)
