...
class AppSenha(AppBase):
    def __init__(self, title):
        ...
        self.label = tkinter.Label(self.frame_dados, font=("arial", 9, "bold") ,text="Digite a senha:", bg="grey55", bd=5)
        ...
        self.texto_relatorio.config(font=("Consolas", 9), width=30, height=4, fg='white', )
